...
class Gallery extends Component {
  ...
  changeImage = (imageUrl, imageAltText) => {
    this.setState({imgUrl: imageUrl, imgAlt: imageAltText})
  }
    ...
    return (
      <div className="bg-container">
        <div className="image-container">
          <img src={imgUrl} alt={imgAlt} className="image-style" />
        </div>
        <div className="para-container">
          <h1 className="nature-para">Nature Photography</h1>
          <p>Nature Photography by Rahul</p>
        </div>
        <ul className="unlist-container">
          {imagesList.map(eachList => (
            <ThumbnailItem
              thumbnailItem={eachList}
              key={eachList.id}
